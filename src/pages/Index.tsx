      ...
      <section className="py-16 bg-kenya-red text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="#" className="px-8 py-3 bg-white text-kenya-red font-bold rounded-md hover:bg-gray-100">
              Find a Car
            </a>
            <a href="#" className="px-8 py-3 bg-transparent border-2 border-white font-bold rounded-md hover:bg-white/10">
              List Your Car
            </a>
          </div>
        </div>
